#
#  Be sure to run `pod spec lint RxRestApiManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/Panevnyk/RxRestApiManager.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "RxRestApiManager/**/*.{swift}"
